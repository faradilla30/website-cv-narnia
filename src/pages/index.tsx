...
import tgs1 from "../styles/1.jpg";
import tgs2 from "../styles/2.jpg";
import tgs3 from "../styles/3.jpg";
import tgs4 from "../styles/4.jpg";
          ...
          <div className="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
            ...
            <div className="mb-2 p-4 md:w-1/2">
              <div className="rounded-mb shadow-md everflow-hidden">
                <Image src={tgs1} alt="online shop" width={999}/>
              </div>
            ...
            <div className="mb-2 p-4 md:w-1/2">
              <div className="rounded-mb shadow-md everflow-hidden">
                <Image src={tgs2} alt="Quis mobile" width={999}/>
              </div>
